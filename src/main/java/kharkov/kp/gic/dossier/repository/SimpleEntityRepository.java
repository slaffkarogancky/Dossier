...
// JpaRepository contains:  
//		count
//		delete, deleteAll, deleteById, deleteInBatch
//		exists, existsById
//		findById, findOne, findAll, findAllById
//		flush
//		getOne
...
public interface SimpleEntityRepository extends JpaRepository<SimpleEntity, Long>{
	...
	@Query("SELECT se FROM SimpleEntity se WHERE LOWER(se.description) LIKE LOWER(CONCAT('%', :substr, '%')) order by se.description ")
